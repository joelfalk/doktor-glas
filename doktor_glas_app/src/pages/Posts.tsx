export const utdrag =
    {
        ...
        content: "12 juni. Jag har aldrig sett en sådan sommar. Rötmånadshetta sedan midten af maj. Hela dagen står ett tjockt töcken af damm alldeles stilla öfver gatorna och torgen.",
